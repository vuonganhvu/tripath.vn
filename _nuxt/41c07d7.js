...
(window.webpackJsonp = window.webpackJsonp || []).push([[5], {
  0: function (t, e, n) {
    ...
    n(40), n(63), n(64), n(105), n(53), n(38), n(66), n(75), n(148), n(151), n(32), n(180), n(50), n(33), n(115), n(137), n(76), n(17), n(158), n(47), n(34), n(182), n(77), n(51), n(183), n(101), n(185), n(146), n(187), n(39), n(54);
    var r = n(45), o = n(30), c = (n(43), n(6)), f = n(71), l = n(1);
            ...
            case 0:
              return e.context || (e.context = {
                ...
                if (t) {
                  ...
                  if ("number" == typeof t || "undefined" !== r && "object" !== r || (n = path || {}, path = t, r = Object(o.a)(path), t = 302), "object" === r && (path = e.router.resolve(path).route.fullPath), !/(^[.]{1,2}\/)|(^\/(?!\/))/.test(path)) throw path = z(path, n), window.location.replace(path), new Error("ERR_REDIRECT");
                  e.context.next({path: path, query: n, status: t})
                }
              }, e.context.nuxtState = window.__NUXT__), t.next = 3, Promise.all([E(n.route), E(n.from)]);
            case 3:
              c = t.sent, f = Object(r.a)(c, 2), l = f[0], h = f[1], n.route && (e.context.route = l), n.from && (e.context.from = h), e.context.next = n.next, e.context._redirected = !1, e.context._errored = !1, e.context.isHMR = !1, e.context.params = e.context.route.params || {}, e.context.query = e.context.route.query || {};
            case 15:
            case"end":
              return t.stop()
          }
    ...
    function M(t, e) {
      return function (t, e) {
        for (var n = new Array(t.length), i = 0; i < t.length; i++) "object" === Object(o.a)(t[i]) && (n[i] = new RegExp("^(?:" + t[i].pattern + ")$", J(e)));
        return function (e, r) {
          for (var path = "", data = e || {}, o = (r || {}).pretty ? B : encodeURIComponent, c = 0; c < t.length; c++) {
            var f = t[c];
            if ("string" != typeof f) {
              var l = data[f.name || "pathMatch"], h = void 0;
              if (null == l) {
                if (f.optional) {
              ...
              if (Array.isArray(l)) {
                ...
                if (h = f.asterisk ? B(l, !0) : o(l), !n[c].test(h)) throw new TypeError('Expected "' + f.name + '" to match "' + f.pattern + '", but received "' + h + '"');
                path += f.prefix + h
              }
            } else path += f
          }
        ...
        for (; null != (n = U.exec(t));) {
          ...
          if (path += t.slice(c, d), c = d + l.length, h) path += h[1]; else {
            var m = t[c], v = n[2], y = n[3], x = n[4], w = n[5], _ = n[6], $ = n[7];
            path && (r.push(path), path = "");
            var O = null != v && null != m && m !== v, j = "+" === _ || "*" === _, C = "?" === _ || "*" === _,
              k = n[2] || f, pattern = x || w;
            r.push({
              name: y || o++,
              prefix: v || "",
    ...
    var r = {
      ...
      render: function (t, e) {
        var n = e.parent, r = e.slots, o = e.props, c = r(), f = c.default;
        void 0 === f && (f = []);
        var l = c.placeholder;
        return n._isMounted ? f : (n.$once("hook:mounted", (function () {
          n.$forceUpdate()
        })), o.placeholderTag && (o.placeholder || l) ? t(o.placeholderTag, {class: ["client-only-placeholder"]}, o.placeholder || l) : f.length > 0 ? f.map((function () {
          return t(!1)
        })) : t(!1))
      }
    };
    ...
    (0, n(98).default)("4a1cbb1a", content, !0, {sourceMap: !1})
  }, 139: function (t, e, n) {
    var content = n(195);
    "string" == typeof content && (content = [[t.i, content, ""]]), content.locals && (t.exports = content.locals);
    (0, n(98).default)("fa7ff0ca", content, !0, {sourceMap: !1})
  }, 140: function (t, e, n) {
    "use strict";
    e.a = function (t, e) {
    ...
    "use strict";
    n(17), n(48), n(43);
    var r = n(6), o = n(1), c = n(0), f = window.__NUXT__;
    ...
    function h() {
      if ((t = this).$vnode && t.$vnode.elm && t.$vnode.elm.dataset && t.$vnode.elm.dataset.fetchKey) {
        ...
        if (data && data._error) this.$fetchState.error = data._error; else for (var e in data) o.a.set(this.$data, e, data[e])
      }
    }
    ...
    (function (t) {
      t.installComponents = function (component, t) {
        const e = "function" == typeof component.exports ? component.exports.extendOptions : component.options;
        ...
        e.functional && function (component, t) {
          ...
          const e = component.exports.render;
    ...
    "use strict";
    n.r(e), function (t) {
      n(40), n(63), n(64), n(105), n(53), n(38), n(66), n(75), n(32), n(50), n(128), n(33), n(76), n(17), n(47), n(34), n(77), n(51), n(147), n(39), n(54), n(48);
      var e = n(30), r = (n(43), n(6)), o = (n(113), n(174), n(178), n(179), n(1)), c = n(140), f = n(99), l = n(0),
        h = n(20), d = n(143), m = n(72);
            ...
            return regeneratorRuntime.wrap((function (t) {
              for (; ;) switch (t.prev = t.next) {
                ...
                case 3:
                  e = t.sent;
                case 4:
                  return f = S(Object(l.s)(e), $.data ? $.data[c] : null), r.components[o] = f, t.abrupt("return", f);
                case 7:
                case"end":
                  return t.stop()
              }
      ...
      function P() {
        return (P = Object(r.a)(regeneratorRuntime.mark((function t(e, n, o) {
          var c, f, d, m, y, w, $, O, C, k, S, E, T, P, A, N = this;
          return regeneratorRuntime.wrap((function (t) {
            for (; ;) switch (t.prev = t.next) {
              case 0:
              ...
              case 2:
                return !1, e === n ? (_ = [], !0) : (c = [], _ = Object(l.g)(n, c).map((function (t, i) {
                  ...
                  n.path === path.path && N.$loading.finish && N.$loading.finish(), n.path !== path.path && N.$loading.pause && N.$loading.pause(), f || (f = !0, o(path))
                }, t.next = 8, Object(l.t)(x, {route: e, from: n, next: d.bind(this)});
              case 8:
              ...
              case 20:
                return $ = t.sent, t.next = 23, R.call(this, y, x.context, $);
              case 23:
                if (!f) {
                  t.next = 25;
                  break
              ...
              case 27:
                ...
                })), this.setTransitions(j(y, e, n)), t.prev = 29, t.next = 32, R.call(this, y, x.context);
              case 32:
                if (!f) {
                  t.next = 34;
                  break
              ...
              case 40:
                return O = t.sent, t.next = 43, R.call(this, y, x.context, O);
              case 43:
                if (!f) {
                  t.next = 45;
                  break
                ...
                return t.next = 82, Promise.all(y.map(function () {
                  var t = Object(r.a)(regeneratorRuntime.mark((function t(r, i) {
                    ...
                    return regeneratorRuntime.wrap((function (t) {
                      for (; ;) switch (t.prev = t.next) {
                        case 0:
                          if (r._path = Object(l.c)(e.matched[m[i]].path)(e.params), r._dataRefresh = !1, o = r._path !== _[i], N._routeChanged && o ? r._dataRefresh = !0 : N._paramChanged && o ? (c = r.options.watchParam, r._dataRefresh = !1 !== c) : N._queryChanged && (!0 === (f = r.options.watchQuery) ? r._dataRefresh = !0 : Array.isArray(f) ? r._dataRefresh = f.some((function (t) {
                            return N._diffQuery[t]
                          })) : "function" == typeof f && (T || (T = Object(l.h)(e)), r._dataRefresh = f.apply(T[i], [e.query, n.query]))), N._hadError || !N._isMounted || r._dataRefresh) {
                            t.next = 6;
                            break
                          }
                          return t.abrupt("return");
                        case 6:
                          ...
                          })), h.push(w)), N.$loading.manual = !1 === r.options.loading, v && ((p = r.options.fetch(x.context)) && (p instanceof Promise || "function" == typeof p.then) || (p = Promise.resolve(p)), p.then((function (t) {
              ...
              case 90:
                return _ = [], Object(l.k)(P), "function" == typeof (A = (h.a.options || h.a).layout) && (A = A(x.context)), t.next = 96, this.loadLayout(A);
              case 96:
            ...
            for (; ;) switch (t.prev = t.next) {
              case 0:
                return x = e.app, w = e.router, e.store, n = new o.a(x), r = function () {
                  n.$mount("#__nuxt"), w.afterEach(A), w.afterEach(N.bind(n)), w.afterEach(M.bind(n)), o.a.nextTick((function () {
                    L(n)
                  }))
                }, t.next = 7, Promise.all(E(w));
              case 7:
                if (c = t.sent, n.setTransitions = n.$options.nuxt.setTransitions.bind(n), c.length && (n.setTransitions(j(c, w.currentRoute)), _ = w.currentRoute.matched.map((function (t) {
                  return Object(l.c)(t.path)(w.currentRoute.params)
                }))), n.$loading = {}, $.error && n.error($.error), w.beforeEach(C.bind(n)), w.beforeEach(T.bind(n)), !$.serverRendered || !Object(l.n)($.routePath, n.context.route.path)) {
                  t.next = 16;
                  break
                }
              ...
              case 16:
                return f = function () {
                  A(w.currentRoute, w.currentRoute), N.call(n, w.currentRoute), D(n), r()
      ...
      Object(h.b)(null, $.config).then((function (t) {
    ...
    (e = n(97)(!1)).push([t.i, ".__nuxt-error-page{padding:1rem;background:#f7f8fb;color:#47494e;text-align:center;display:flex;justify-content:center;align-items:center;flex-direction:column;font-family:sans-serif;font-weight:100!important;-ms-text-size-adjust:100%;-webkit-text-size-adjust:100%;-webkit-font-smoothing:antialiased;position:absolute;top:0;left:0;right:0;bottom:0}.__nuxt-error-page .error{max-width:450px}.__nuxt-error-page .title{font-size:1.5rem;margin-top:15px;color:#47494e;margin-bottom:8px}.__nuxt-error-page .description{color:#7f828b;line-height:21px;margin-bottom:10px}.__nuxt-error-page a{color:#7f828b!important;text-decoration:none}.__nuxt-error-page .logo{position:fixed;left:12px;bottom:12px}", ""]), t.exports = e
  }, 194: function (t, e, n) {
    "use strict";
    n(139)
  }, 195: function (t, e, n) {
    (e = n(97)(!1)).push([t.i, ".nuxt-progress{position:fixed;top:0;left:0;right:0;height:2px;width:0;opacity:1;transition:width .1s,opacity .4s;background-color:#000;z-index:999999}.nuxt-progress.nuxt-progress-notransition{transition:none}.nuxt-progress-failed{background-color:red}", ""]), t.exports = e
  }, 198: function (t, e, n) {
    "use strict";
    ...
    n(40), n(53), n(38), n(32), n(33), n(115), n(137), n(76), n(17), n(39), n(43);
    var r = n(6), o = n(71), c = n(1), f = n(44), l = n(141), h = n(100), d = n.n(h), m = n(31), v = n.n(m), y = n(46),
      x = n(0);
    n(191), n(128);
    ...
    var $ = {
      ...
      routes: [{
        path: "/", component: function () {
          return Object(x.m)(Promise.all([n.e(2), n.e(6), n.e(3)]).then(n.bind(null, 271)))
        }, name: "index"
      }],
      fallback: !1
    };
    ...
    var j = {
      ...
      }, E = (n(192), n(29)), R = Object(E.a)(S, (function () {
      ...
      }], !1, null, null, null).exports, T = (n(47), n(34), n(101), n(45)), P = {
        name: "Nuxt",
        components: {NuxtChild: j, NuxtError: R},
        props: {
      ...
      }, A = (n(63), n(64), n(66), n(50), n(51), n(54), n(48), {
      ...
      }), N = (n(194), Object(E.a)(A, void 0, void 0, !1, null, null, null).exports), D = (n(196), n(144));
    ...
    var I = {_default: Object(x.s)(D.a)}, U = {
      render: function (t, e) {
                ...
                case 3:
                  return t.$loading.start(), r = n.map((function (e) {
                    ...
                    if (e.$options.fetch && e.$options.fetch.length && p.push(Object(x.q)(e.$options.fetch, t.context)), e.$fetch) p.push(e.$fetch()); else {
                      var n, r = M(Object(x.e)(e.$vnode.componentInstance));
                      try {
                        for (r.s(); !(n = r.n()).done;) {
    ...
    var B = {};
    B.modules = B.modules || {};
    var F = B instanceof Function ? B : function () {
      return new f.a.Store(Object.assign({strict: !1}, B))
    };
    var K = {};
    for (var J in K) c.a.component(J, K[J]);
    ...
    c.a.component(d.a.name, d.a), c.a.component(v.a.name, H(H({}, v.a), {}, {
      render: function (t, e) {
    ...
    }), c.a.use(l.a, {keyName: "head", attribute: "data-n-head", ssrAttribute: "data-n-head-ssr", tagIDKeyName: "hid"});
    var X = {
      name: "page",
      mode: "out-in",
      appear: !0,
    ...
    function W() {
      return (W = Object(r.a)(regeneratorRuntime.mark((function t(e) {
        var n, r, o, f, l, h, path, d, m = arguments;
        return regeneratorRuntime.wrap((function (t) {
          for (; ;) switch (t.prev = t.next) {
            case 0:
            ...
            case 4:
              return r = t.sent, (o = F(e)).$router = r, f = H({
                head: {
                  title: "tripath",
                  meta: [{charset: "utf-8"}, {
                    name: "viewport",
                  ...
                  defaultTransition: X, transitions: [X], setTransitions: function (t) {
              ...
              }, U), o.app = f, l = e ? e.next : function (t) {
                return f.router.push(t)
              }, e ? h = r.resolve(e.url).route : (path = Object(x.f)(r.options.base, r.options.mode), h = r.resolve(path).route), t.next = 13, Object(x.t)(f, {
                store: o,
                route: h,
                next: l,
            ...
            case 13:
              d("config", n), window.__NUXT__ && window.__NUXT__.state && o.replaceState(window.__NUXT__.state), f.context.enablePreview = function () {
    ...
    var r = {
      ...
      render: function (t, e) {
        ...
        return n._isMounted ? f : (n.$once("hook:mounted", (function () {
          n.$forceUpdate()
        })), o.placeholderTag && (o.placeholder || l) ? t(o.placeholderTag, {class: ["no-ssr-placeholder"]}, o.placeholder || l) : f.length > 0 ? f.map((function () {
          return t(!1)
        })) : t(!1))
      }
    };
    ...
    "use strict";
    n(40), n(63), n(64), n(53), n(38), n(66), n(75), n(32), n(50), n(33), n(17), n(34), n(77), n(51), n(39), n(54), n(48);
    var r = n(1);
    ...
    function r(t, e) {
      for (var n = [], r = {}, i = 0; i < e.length; i++) {
        var o = e[i], c = o[0], f = {id: t + ":" + i, css: o[1], media: o[2], sourceMap: o[3]};
    ...
    var c = {}, head = o && (document.head || document.getElementsByTagName("head")[0]), f = null, l = 0, h = !1,
      d = function () {
      }, m = null, v = "undefined" != typeof navigator && /msie [6-9]\b/.test(navigator.userAgent.toLowerCase());
    ...
    function _(t) {
      ...
      if (v) {
        var o = l++;
        r = f || (f = w()), e = j.bind(null, r, o, !1), n = j.bind(null, r, o, !0)
      } else r = w(), e = C.bind(null, r), n = function () {
        r.parentNode.removeChild(r)
      };
    ...
    function j(t, e, n, r) {
      var o = n ? "" : r.css;
      if (t.styleSheet) t.styleSheet.cssText = O(e, o); else {
        var c = document.createTextNode(o), f = t.childNodes;
